...
// uplatnica_get.php — dohvati jednu uplatnicu po ID-u
...
try {
    ...
    $out = [
        'id'                  => (int)$row['id'],
        'uplatilac_id'        => isset($row['uplatilac_id']) ? (int)$row['uplatilac_id'] : null,
        'uplatilac_naziv'     => $row['uplatilac_naziv'],
        'uplatilac_tekst'     => $row['uplatilac_tekst'],
        'adresa'              => $row['adresa'],
        'telefon'             => $row['telefon'],
        'svrha_id'            => isset($row['svrha_id']) ? (int)$row['svrha_id'] : null,
        'svrha'               => $row['svrha'],
        'svrha1'              => $row['svrha1'],
        'primatelj_id'        => isset($row['primatelj_id']) ? (int)$row['primatelj_id'] : null,
        'primatelj_naziv'     => $row['primatelj_naziv'],
        'primatelj_tekst'     => $row['primatelj_tekst'],
        'mjesto_uplate'       => $row['mjesto_uplate'],
        'racun_posiljaoca'    => $row['racun_posiljaoca'],
        'racun_primatelja'    => $row['racun_primatelja'],
        'iznos'               => isset($row['iznos']) ? (float)$row['iznos'] : 0,
        'valuta'              => $row['valuta'],
        'datum_uplate'        => $row['datum_uplate'],
        'poziv_na_broj'       => $row['poziv_na_broj'],
        'broj_poreskog_obv'   => $row['broj_poreskog_obv'],
        'vrsta_prihoda_sifra' => $row['vrsta_prihoda_sifra'],
        'opcina_sifra'        => $row['opcina_sifra'],
        'budzetska_org_sifra' => $row['budzetska_org_sifra'],
    ];
